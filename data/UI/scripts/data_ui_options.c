...
{   
    ...
    UI_Element_set_fields(&options_colors_toggle.rect, get_width(&options_gameplay_toggle.rect, 1.0), 0, WINDOW_WIDTH/4, WINDOW_HEIGHT/10, outlines[0], inlines[1], TOP_LEFT);
    ...
    UI_Element_set_fields(&options_video_toggle.rect, options_colors_toggle.rect.x + get_width(&options_colors_toggle.rect, 1.0), 0, WINDOW_WIDTH/4, WINDOW_HEIGHT/10, outlines[0], inlines[1], TOP_LEFT);
    ...
    UI_Element_set_fields(&options_audio_toggle.rect, options_video_toggle.rect.x + get_width(&options_video_toggle.rect, 1.0), 0, WINDOW_WIDTH/4, WINDOW_HEIGHT/10, outlines[0], inlines[1], TOP_LEFT);
