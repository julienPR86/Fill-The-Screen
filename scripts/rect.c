...
void rect_render(Rect *rect)
{
    ...
    SDL_FRect outline_rect = {rect->x - rect->outline, rect->y - rect->outline, rect->w + rect->outline*2, rect->h + rect->outline*2};
    SDL_FRect main_rect = {rect->x, rect->y, rect->w, rect->h};
