...
int options()
{
    ...
    Label probability_silder_description_label = {20, 150*SCALEY, 0, 0, 0.075, "Blocks spawn probability", roboto_regular, {0, 0, 0, 255}, NULL, NULL, false, true};
    label_init(&probability_silder_description_label);

    Label probability_slider_label = {0, 0, 0, 0, 0.06, NULL, roboto_regular, {0, 0, 0, 255}, NULL, NULL, false, true};
    ...
    Label map_width_slider_description_label = {20, 225*SCALEY, 0, 0, 0.075, "Map width", roboto_regular, {0, 0, 0, 255}, NULL, NULL, false, true};
    label_init(&map_width_slider_description_label);

    Label map_width_slider_label = {0, 0, 0, 0, 0.06, NULL, roboto_regular, {0, 0, 0, 255}, NULL, NULL, false, true};
    ...
    Label map_height_slider_description_label = {20, 300*SCALEY, 0, 0, 0.075, "Map height", roboto_regular, {0, 0, 0, 255}, NULL, NULL, false, true};
    label_init(&map_height_slider_description_label);

    Label map_height_slider_label = {0, 0, 0, 0, 0.06, NULL, roboto_regular, {0, 0, 0, 255}, NULL, NULL, false, true};
    ...
    Label game_speed_slider_description = {20, 375*SCALEY, 0, 0, 0.075, "Game speed", roboto_regular, {0, 0, 0, 255}, NULL, NULL, false, true};
    label_init(&game_speed_slider_description);

    Label game_speed_slider_label = {0, 0, 0, 0, 0.06, NULL, roboto_regular, {0, 0, 0, 255}, NULL, NULL, false, true};
    ...
    Label player_red_slider_description_label = {20, 150*SCALEY, 0, 0, 0.075, "Red", roboto_regular, {0, 0, 0, 255}, NULL, NULL, false, true};
    label_init(&player_red_slider_description_label);

    Label player_red_slider_label = {0, 0, 0, 0, 0.06, NULL, roboto_regular, {0, 0, 0, 255}, NULL, NULL, false, true};
    ...
    Label player_green_slider_description_label = {20, 200*SCALEY, 0, 0, 0.075, "Green", roboto_regular, {0, 0, 0, 255}, NULL, NULL, false, true};
    label_init(&player_green_slider_description_label);

    Label player_green_slider_label = {0, 0, 0, 0, 0.06, NULL, roboto_regular, {0, 0, 0, 255}, NULL, NULL, false, true};
    ...
    Label player_blue_slider_description_label = {20, 250*SCALEY, 0, 0, 0.075, "Blue", roboto_regular, {0, 0, 0, 255}, NULL, NULL, false, true};
    label_init(&player_blue_slider_description_label);

    Label player_blue_slider_label = {0, 0, 0, 0, 0.06, NULL, roboto_regular, {0, 0, 0, 255}, NULL, NULL, false, true};
    ...
    Label collision_square_red_slider_description_label = {350, 150*SCALEY, 0, 0, 0.075, "Red", roboto_regular, {0, 0, 0, 255}, NULL, NULL, false, true};
    label_init(&collision_square_red_slider_description_label);

    Label collision_square_red_slider_label = {0, 0, 0, 0, 0.06, NULL, roboto_regular, {0, 0, 0, 255}, NULL, NULL, false, true};
    ...
    Label collision_square_green_slider_description_label = {350, 200*SCALEY, 0, 0, 0.075, "Green", roboto_regular, {0, 0, 0, 255}, NULL, NULL, false, true};
    label_init(&collision_square_green_slider_description_label);

    Label collision_square_green_slider_label = {0, 0, 0, 0, 0.06, NULL, roboto_regular, {0, 0, 0, 255}, NULL, NULL, false, true};
    ...
    Label collision_square_blue_slider_description_label = {350, 250*SCALEY, 0, 0, 0.075, "Blue", roboto_regular, {0, 0, 0, 255}, NULL, NULL, false, true};
    label_init(&collision_square_blue_slider_description_label);

    Label collision_square_blue_slider_label = {0, 0, 0, 0, 0.06, NULL, roboto_regular, {0, 0, 0, 255}, NULL, NULL, false, true};
    ...
    Label line_square_red_slider_description_label = {700, 150*SCALEY, 0, 0, 0.075, "Red", roboto_regular, {0, 0, 0, 255}, NULL, NULL, false, true};
    label_init(&line_square_red_slider_description_label);

    Label line_square_red_slider_label = {0, 0, 0, 0, 0.06, NULL, roboto_regular, {0, 0, 0, 255}, NULL, NULL, false, true};
    ...
    Label line_square_green_slider_description_label = {700, 200*SCALEY, 0, 0, 0.075, "Green", roboto_regular, {0, 0, 0, 255}, NULL, NULL, false, true};
    label_init(&line_square_green_slider_description_label);

    Label line_square_green_slider_label = {0, 0, 0, 0, 0.06, NULL, roboto_regular, {0, 0, 0, 255}, NULL, NULL, false, true};
    ...
    Label line_square_blue_slider_description_label = {700, 250*SCALEY, 0, 0, 0.075, "Blue", roboto_regular, {0, 0, 0, 255}, NULL, NULL, false, true};
    label_init(&line_square_blue_slider_description_label);

    Label line_square_blue_slider_label = {0, 0, 0, 0, 0.06, NULL, roboto_regular, {0, 0, 0, 255}, NULL, NULL, false, true};
    ...
    Label empty_square_red_slider_description_label = {20, 400*SCALEY, 0, 0, 0.075, "Red", roboto_regular, {0, 0, 0, 255}, NULL, NULL, false, true};
    label_init(&empty_square_red_slider_description_label);

    Label empty_square_red_slider_label = {0, 0, 0, 0, 0.06, NULL, roboto_regular, {0, 0, 0, 255}, NULL, NULL, false, true};
    ...
    Label empty_square_green_slider_description_label = {20, 450*SCALEY, 0, 0, 0.075, "Green", roboto_regular, {0, 0, 0, 255}, NULL, NULL, false, true};
    label_init(&empty_square_green_slider_description_label);

    Label empty_square_green_slider_label = {0, 0, 0, 0, 0.06, NULL, roboto_regular, {0, 0, 0, 255}, NULL, NULL, false, true};
    ...
    Label empty_square_blue_slider_description_label = {20, 500*SCALEY, 0, 0, 0.075, "Blue", roboto_regular, {0, 0, 0, 255}, NULL, NULL, false, true};
    label_init(&empty_square_blue_slider_description_label);

    Label empty_square_blue_slider_label = {0, 0, 0, 0, 0.06, NULL, roboto_regular, {0, 0, 0, 255}, NULL, NULL, false, true};
    ...
    Label max_fps_silder_description_label = {20, 150*SCALEY, 0, 0, 0.075, "Max FPS", roboto_regular, {0, 0, 0, 255}, NULL, NULL, false, true};
    label_init(&max_fps_silder_description_label);

    Label max_fps_slider_label = {0, 0, 0, 0, 0.06, NULL, roboto_regular, {0, 0, 0, 255}, NULL, NULL, false, true};
    ...
    Label master_audio_silder_description_label = {20, 150*SCALEY, 0, 0, 0.075, "Master volume", roboto_regular, {0, 0, 0, 255}, NULL, NULL, false, true};
    label_init(&master_audio_silder_description_label);

    Label master_audio_slider_label = {0, 0, 0, 0, 0.06, NULL, roboto_regular, {0, 0, 0, 255}, NULL, NULL, false, true};
    ...
    Label music_audio_silder_description_label = {20, 225*SCALEY, 0, 0, 0.075, "Music volume", roboto_regular, {0, 0, 0, 255}, NULL, NULL, false, true};
    label_init(&music_audio_silder_description_label);

    Label music_audio_slider_label = {0, 0, 0, 0, 0.06, NULL, roboto_regular, {0, 0, 0, 255}, NULL, NULL, false, true};
    ...
    Label effects_audio_silder_description_label = {20, 300*SCALEY, 0, 0, 0.075, "Effects volume", roboto_regular, {0, 0, 0, 255}, NULL, NULL, false, true};
    label_init(&effects_audio_silder_description_label);

    Label effects_audio_slider_label = {0, 0, 0, 0, 0.06, NULL, roboto_regular, {0, 0, 0, 255}, NULL, NULL, false, true};
