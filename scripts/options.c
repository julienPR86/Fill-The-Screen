...
int options()
{
    ...
    Toogle gameplay_toogle = {0, 0, WIDTH/SCALE/4, HEIGHT/10, NORMAL, &gameplay_toogle_label, &toogle_style, &option_gameplay, true};
    toogle_init(&gameplay_toogle);
    Toogle colors_toogle = {toogle_width(&gameplay_toogle, SCALE), 0, WIDTH/SCALE/4, HEIGHT/10, NORMAL, &colors_toogle_label, &toogle_style, &option_color_label, true};
    toogle_init(&colors_toogle);
    Toogle video_toogle = {colors_toogle.x + toogle_width(&colors_toogle, SCALE), 0, WIDTH/SCALE/4, HEIGHT/10, NORMAL, &video_toogle_label, &toogle_style, &option_video, true};
    toogle_init(&video_toogle);
    Toogle audio_toogle = {video_toogle.x + toogle_width(&video_toogle, SCALE), 0, WIDTH/SCALE/4, HEIGHT/10, NORMAL, &audio_toogle_label, &toogle_style, &option_audio, true};
    ...
    Label probability_silder_description_label = {20, 150*SCALE, 0, 0, "Blocks spawn probability", 20, {0, 0, 0, 255}, NULL, NULL, false, true};
    ...
    Label max_fps_silder_description_label = {20, 150*SCALE, 0, 0, "Max FPS", 20, {0, 0, 0, 255}, NULL, NULL, false, true};
    ...
    Label master_audio_silder_description_label = {20, 150*SCALE, 0, 0, "Master volume", 20, {0, 0, 0, 255}, NULL, NULL, false, true};
    ...
    Label music_audio_silder_description_label = {20, 225*SCALE, 0, 0, "Music volume", 20, {0, 0, 0, 255}, NULL, NULL, false, true};
    ...
    Label effects_audio_silder_description_label = {20, 300*SCALE, 0, 0, "Effects volume", 20, {0, 0, 0, 255}, NULL, NULL, false, true};
