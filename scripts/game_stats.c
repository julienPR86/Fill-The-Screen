...
int game_stats()
{
    ...
    Button back_button = {{20, 400, 150, 50, NO_OUTLINE, NO_INLINE}, NORMAL, &back_button_label, &button_style, &back, true};
    button_init(&back_button);

    Button restart_button = {{20, 500, 150, 50, NO_OUTLINE, NO_INLINE}, NORMAL, &restart_button_label, &button_style, &restart, true};
    button_init(&restart_button);

    Button main_menu_button = {{20, 600, 150, 50, NO_OUTLINE, NO_INLINE}, NORMAL, &main_menu_button_label, &button_style, &main_menu, true};
