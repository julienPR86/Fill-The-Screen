...
int pause_menu()
{
    ...
    Button back_button = {CENTER(WIDTH, 150*SCALEX), CENTER(HEIGHT, 50*SCALEY), 150, 50, NORMAL, back_button_label, basic_button_style, &back};
    button_init(&back_button);
    Button restart_button = {CENTER(WIDTH, 150*SCALEX), back_button.y+button_height(&back_button)+10*SCALEY, 150, 50, NORMAL, restart_button_label, basic_button_style, &restart};
