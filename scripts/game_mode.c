...
int mode_choice()
{
    Label title_label = {{WINDOW_WIDTH/2, 20, 0, 0, NO_OUTLINE, NO_INLINE, TOP_CENTER}, "Game mode Choice", 100, {255, 0, 0, 255}, NULL, NULL, false, 1.0, true};
    ...
    Button fill_mode_button = {{WINDOW_WIDTH/2, WINDOW_HEIGHT/2 - 100, 200, 50, outlines[2], inlines[1], CENTER}, NORMAL, &fill_mode_button_label, &button_style, &fill_mode, true};
    button_init(&fill_mode_button, SCALE_X, SCALE_Y);

    Button discovery_mode_button = {{WINDOW_WIDTH/2, WINDOW_HEIGHT/2, 200, 50, outlines[2], inlines[1], CENTER}, NORMAL, &discovery_mode_button_label, &button_style, &discovery_mode, true};
    button_init(&discovery_mode_button, SCALE_X, SCALE_Y);

    Button constraint_mode_button = {{WINDOW_WIDTH/2, WINDOW_HEIGHT/2 + 100, 200, 50, outlines[2], inlines[1], CENTER}, NORMAL, &constraint_mode_button_label, &button_style, &constraint_mode, true};
    button_init(&constraint_mode_button, SCALE_X, SCALE_Y);

    Button free_mode_button = {{WINDOW_WIDTH/2, WINDOW_HEIGHT/2 + 200, 200, 50, outlines[2], inlines[1], CENTER}, NORMAL, &free_mode_button_label, &button_style, &free_mode, true};
