...
int main(int argc, char **argv)
{
    ...
    Button play_button = {0, 0, 150, 50, NORMAL, play_button_label, &current_button_style, &mode_choice, true, false};
    if (NULL != button_init(&play_button))
    {
        set_button_anchor(&play_button, CENTER, 0, 0);
    }

    Button options_button = {0, 0, 150, 50, NORMAL, options_button_label, &current_button_style, &options, true, false};
    if (NULL != button_init(&options_button))
    {
        set_button_anchor(&options_button, CENTER, 0, button_height(&play_button)+10 * SCALEY);
    }

    Button exit_button = {0, 0, 150, 50, NORMAL, exit_button_label, &current_button_style, &exit_game, true, false};
