...
int main(int argc, char **argv)
{
    ...
    Label title = {20, 10, 600, 100, 0, 0.3, "Fill The Screen", roboto_regular, {255,255,255,255}, {255,40,0,255}, {0,0,0,255}};

    Button play_button = {10, HEIGHT/2, 150, 50, 1, 10, 2, "PLAY", 0, roboto_light, {255,0,0,255}, {255,128,0,255}, {0,0,0,255}, {0,0,0,255}, &mode_choice};
    Button exit_button = {10, HEIGHT/2+66, 150, 50, 1, 10, 2, "QUIT", 0, roboto_light, {255,0,0,255}, {255,128,0,255}, {0,0,0,255}, {0,0,0,255}, &exit_game};
