...
int main()
{
    ...
    Label title_label = {0, 0, 0, 0, "Fill The Screen", 100, {255, 0, 0, 255}, NULL, NULL, NULL, false, true};
    if (NULL != label_init(&title_label))
    {
        set_label_anchor(&title_label, CENTER_X, 0, 10);
    }

    Label play_button_label = {0, 0, 0, 0, "PLAY", 30, {0, 0, 0, 255}, NULL, NULL, NULL, false, true};
    Label options_button_label = {0, 0, 0, 0, "Options", 30, {0, 0, 0, 255}, NULL, NULL, NULL, false, true};
    Label exit_button_label = {0, 0, 0, 0, "Quit", 30, {0, 0, 0, 255}, NULL, NULL, NULL, false, true};
